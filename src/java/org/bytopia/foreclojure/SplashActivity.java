...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("org.bytopia.foreclojure.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("org.bytopia.foreclojure.ProblemGridActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading ProblemGridActivity", e);
                    }
